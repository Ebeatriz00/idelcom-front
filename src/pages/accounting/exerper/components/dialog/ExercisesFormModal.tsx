...
export function ExercisesFormModal({
  open,
  onClose,
  onSubmit,
  title,
  ...
  open: boolean;
  onClose: () => void;
  onSubmit: (dto: ExercisesUpsertDto) => Promise<void> | void;
  title: string;
  defaultValues: Partial<ExercisesUpsertDto>;
  saving: boolean;
  loadingDetail: boolean;
}) {
  const [exercisesId, setExercisesId] = useState<number | undefined>(
    defaultValues?.exercisesId
  );
  ...
  useEffect(() => {
    setExercisesId(defaultValues?.exercisesId);
