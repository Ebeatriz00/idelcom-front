...
type Props = {
  ...
  defaultValues: ContactTypeUpsertDto;
  onClose: () => void;
  onSubmit: (dto: ContactTypeUpsertDto) => Promise<void>;
  saving: boolean;
};

export function ContactTypeFormModal({
  open,
  title,
  loadingDetail,
  defaultValues,
  ...
  return (
    ...
    >
      {loadingDetail ? (
        ...
        <ContactTypeForm
          key={defaultValues.contactTypeId ?? "new"}
