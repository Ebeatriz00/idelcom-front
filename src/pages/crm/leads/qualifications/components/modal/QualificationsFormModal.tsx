...
type Props = {
  ...
  onClose: () => void;
  onSubmit: (dto: QualificationsUpsertDto) => Promise<void>;
  saving: boolean;
};

export function QualificationsFormModal({
  open,
  title,
  loadingDetail,
  defaultValues,
  ...
  const formId = "qualifications-form";
  return (
    <Modal
      title={title}
      size="xl"
    ...
    >
      {loadingDetail ? (
        ...
        <QualificationsForm
          key={defaultValues.leadsQualificationsId ?? "new"}
