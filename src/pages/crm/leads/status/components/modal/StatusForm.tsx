...
export function StatusForm({
  ...
  onSubmit: (dto: LeadsStatusUpsertDto) => void;
  saving?: boolean;
  formId?: string;
  showActions?: boolean;
  autofocus?: boolean;
}) {
  const [leadsStatusId, setLeadsStatusId] = useState<number | undefined>(
    defaultValues?.leadsStatusId
  );
  ...
  useEffect(() => {
    setLeadsStatusId(defaultValues?.leadsStatusId);
