...
import { SsomaDocumentTypeForm } from "./SsomaDocumentTypeForm";

export function SsomaDocumentTypeFormModal({
  open,
  title,
  loadingDetail,
  defaultValues,
  ...
  const formId = "ssoma-document-type-form";
  return (
    <Modal
      title={title}
      size="xl"
    ...
    >
      {loadingDetail ? (
        ...
        <SsomaDocumentTypeForm
          key={defaultValues.ssomaDocumentTypeId ?? "new"}
