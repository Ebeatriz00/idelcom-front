...
type Row = NonNullable<PreSaleProyectsDetailDto["activityList"]>[number];
...
export type ActivityItemProps = {
  ...
  onClick?: () => void;
  onChangeStatus?: (projectToken: string, lineToken: string | null) => void;
  onChangePriority?: (projectToken: string, lineToken: string | null) => void;
